...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : M1_ENA_Pin M2_ENA_Pin */
  GPIO_InitStruct.Pin = M1_ENA_Pin|M2_ENA_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : HOME1_Pin HOME2_Pin
    Microswitch wiring: input to NO contact, COM to GND, internal pull-up enabled.
    Active state is low by default. */
  GPIO_InitStruct.Pin = HOME1_Pin|HOME2_Pin;
